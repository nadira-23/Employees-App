    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{backgroundColor: '#295F98'}}>
        <Toolbar>
          ...
          <Link to={'/home'} style={{color: 'white'}}><Button color="inherit" sx={{border: 1, margin: 1, '&:hover': { border: 'none', 
          backgroundColor: 'white', color: '#86D293'},'&:focus': {outline: 'none'}}}>Home</Button></Link>

        <Link to={'/add'} style={{color: 'white'}}><Button color="inherit" sx={{border: 1,margin: 1, '&:hover': { border: 'none', 
        backgroundColor: 'white', color: '#86D293'},'&:focus': {outline: 'none'}}}>Add</Button></Link>
        <Button color="inherit" sx={{border: 1,margin: 1, '&:hover': { border: 'none', 
